...
let myApp = Vue.createApp({
    ...
    methods: {
        getWeather(event) {
            ...
            //TODO: Get the forecast for this location, and display it.
        },
        positionCursor(event) {
            //TODO: Put a marker where they clicked.
        }
    },
    computed: {
        message() {
            return "You have selected " + this.latitude.toFixed(2) + ", " + this.longitude.toFixed(2);
        }
    }
}).mount("#app");

fetch("http://api.weather.gov/radar/stations")
